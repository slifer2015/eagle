<div align="center">
    <table border="0" cellspacing="0" cellpadding="0" style="max-width:600px">
        ...
        <tr>
            <td>
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tbody>
                    <tr>
                        <td align="right"><img src="{{ asset('images/tinker2.png') }}" width="100px" height="32px" style="display:block"></td>
                    </tr>
                    </tbody>
                </table>
            </td>
        ...
        <tr>
            <td>
                <table bgcolor="#ff685d" width="100%" border="0" cellspacing="0" cellpadding="0"
                    ...
                    <tr>
                        ...
                        <td align="right" dir="rtl" style="font-family:Tahoma,Roboto-Regular,Helvetica,Arial,sans-serif;font-size:20px;color:#ffffff;line-height:1.25">
                            به سامانه آموزشی Tinker خوش آمدید .
                        </td>
                        <td width="32px"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                            <table style="min-width:300px" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td style="font-family:Tahoma,Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">
                                        ...
                                        <div align="center" dir="ltr">
                                            <a href="{{ url('/email',[ $user['confirmation_code'] ]) }}" target="_blank">{{ url('/email',[ $user['confirmation_code'] ]) }}</a>
                                        </div>
                                    </td>
                                </tr>
                                <tr height="32px"></tr>
                                <tr>
                                    <td style="font-family:Tahoma,Roboto-Regular,Helvetica,Arial,sans-serif;font-size:13px;color:#202020;line-height:1.5">
                                        با احترام<br>تیم مدیریت کاربران Tinker
                                    </td>
                                </tr>
                                <tr height="16px"></tr>
                                </tbody>
